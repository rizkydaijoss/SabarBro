...
public class FragmentRekomendasi extends Fragment {
    ...
    private AdapterRekomendasi mAdapter;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        // Set title bar
        return inflater.inflate(R.layout.activity_fragment_rekomendasi, container, false);
    }
    ...
    private class AsyncLogin extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://masgandos.pe.hu/sabarbro/rekomendasi.json");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                mAdapter = new AdapterRekomendasi(getActivity().getApplicationContext(), data);
